...
/bin/ls microshell.c
/bin/ls microshell.c | cd ../ | /bin/pwd 
/bin/ls microshell.c
/bin/ls microshell.c
/bin/ls salut
/bin/echo OK
...
/bin/cat reserv_microsh.c | /usr/bin/grep a | /usr/bin/grep b ; /bin/cat reserv_microsh.c ;
/bin/cat reserv_microsh.c | /usr/bin/grep a | /usr/bin/grep w ; /bin/cat reserv_microsh.c ;
/bin/cat reserv_microsh.c | /usr/bin/grep a | /usr/bin/grep w ; /bin/cat reserv_microsh.c
/bin/cat reserv_microsh.c ; /bin/cat reserv_microsh.c | /usr/bin/grep a | /usr/bin/grep b | /usr/bin/grep z ; /bin/cat reserv_microsh.c
/bin/cat reserv_microsh.c ; /bin/cat reserv_microsh.c | /usr/bin/grep a | /usr/bin/grep b | /usr/bin/grep z ; /bin/cat reserv_microsh.c
blah | /bin/echo OK
blah | /bin/echo OK
blah | /bin/echo OK
rm -rf microshell.dSYM microshell